...
<body>
    ...
    $fav_fruit = htmlspecialchars(trim($_POST["fav_fruit"] ?? ""));
    ...
    $hibak = [];
    if (!preg_match("/^[A-ZÁÉÍÓÖŐÚÜŰ a-záéíóöőúüű](4,)$/u",$nev)) {
...
?>
<a href="Q5A3L5_urlap.html"><strong>Vissza az űrlapra.</strong></a>
</body>
</html>